Dmptool2::Application.routes.draw do
  # Have an optional locale specifier as the first URL component.
  # All locales known to I18n, which can be whitelisted in
  # config/application.rb, are allowed.
  scope "(:locale)",
    ...
    resources :requirements_templates do
      ...
      resources :resource_contexts, except: :show
      member do
        get :toggle_active
        get :basic
      end
